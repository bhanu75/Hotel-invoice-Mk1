            ...
            <div class="invoice-details">
              ...
              <div>
                ...
                <div class="detail-row">
                  ...
                  <span class="detail-value">${new Date(bill.date).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}</span>
                </div>
                ${bill.checkIn ? `<div class="detail-row">
                  <span class="detail-label">Check-In:</span>
                  <span class="detail-value">${new Date(bill.checkIn).toLocaleDateString('en-GB')}</span>
                </div>` : ''}
                ${bill.checkOut ? `<div class="detail-row">
                  <span class="detail-label">Check-Out:</span>
                  <span class="detail-value">${new Date(bill.checkOut).toLocaleDateString('en-GB')}</span>
                </div>` : ''}
              </div>
            </div>
